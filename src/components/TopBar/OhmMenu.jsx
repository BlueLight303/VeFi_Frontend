...
const addTokenToWallet = (tokenSymbol, tokenAddress) => async () => {
  if (window.ethereum) {
    ...
    const tokenPath = tokenSymbol === "VEFI" ? OhmImg : SOhmImg;
              ...
              <Paper className="ohm-menu" elevation={1}>
                <Box component="div" className="buy-tokens">
                  ...
                  >
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                      <Typography align="left">
                      Get VEFI-BUSD LP <SvgIcon component={ArrowUpIcon} htmlColor="#A3A3A3" />
                      </Typography>
                    </Button>
                  </Link>
                ...
                {(
                  <Box className="add-tokens">
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("VEFI", CST_ADDRESS)}>
                        <TokenIcon size={32} symbol="PID"/>
                        <Typography variant="body1">VEFI</Typography>
                      </Button>
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("sCST", SCST_ADDRESS)}>
                        <TokenIcon size={32} symbol="sPID"/> 
                        <Typography variant="body1">sVEFI</Typography>
                      </Button>
