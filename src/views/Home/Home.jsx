  ...
  return <div className="home_gd">
    ...
    <div className="boodyBox fxColumn">
      ...
      <div className="contentStyle">
        CryptStarter DAO is a decentralized reserve currency protocol based on the VEFI token and aims at building a community-owned decentralized financial infrastructure for the crypto world.
      </div>
...
function Inp_Box({idoBalance,busdAmount}) {
  ...
  return <MinInp_Box>
    ...
    PIDAO project will launch on 12:00 8th Nov. 2021, you will be able to claim your VEFI token manually on the website. 
    </div>
