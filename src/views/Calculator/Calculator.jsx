        ...
        <Paper className={`ohm-card`}>
          <Grid container direction="column" spacing={2}>
                ...
                <Grid container spacing={2} alignItems="flex-end">
                  ...
                  <Grid item xs={12} sm={4} md={4} lg={4}>
                    <div className="stake-index">
                      ...
                      <Typography variant="h4">
                        {currentIndex ? <>{trim(currentIndex, 1)} VEFI</> : <Skeleton width="150px" />}
                      </Typography>
                    </div>
                  </Grid>
                </Grid>
            ...
            <Grid item>
              ...
              <Grid container spacing={2} alignItems="flex-end">
                <Grid item xs={12} sm={6} md={6} lg={6}>
                  <Typography variant="h6">VEFI rewards estimation</Typography>
                </Grid>
                <Grid item xs={12} sm={6} md={6} lg={6}>
                  <Typography variant="h6" align={"right"}>{isAppLoading ? <Skeleton width="80px" /> : <>{trim(rewardsEstimation, 2)} VEFI</>}</Typography>
                </Grid>
              </Grid>
              <Grid container spacing={2} alignItems="flex-end">
                <Grid item xs={12} sm={6} md={6} lg={6}>
