...
function Stake() {
  ...
  const onChangeStake = async action => {
    ...
    if (action === "stake" && gweiValue.gt(ethers.utils.parseUnits(kageBalance, "gwei"))) {
      return dispatch(error("You cannot stake more than your VEFI balance."));
    }
            ...
            <div className="staking-area">
              {!address ? (
                <div className="stake-wallet-notification">
                  ...
                  <Typography variant="h6">Connect your wallet to stake VEFI</Typography>
                </div>
              ) : (
                <>
                    ...
                    <Box className="stake-action-row " display="flex" alignItems="center">
                      ...
                      <TabPanel value={view} index={0} className="stake-tab-panel">
                        {address && hasAllowance("ohm") ? (
                          ...
                          >
                            {txnButtonText(pendingTransactions, "staking", "Stake VEFI")}
                          </Button>
                        ) : (
                          <Button
                            className="stake-button"
                      ...
                      <TabPanel value={view} index={1} className="stake-tab-panel">
                        ...
                        >
                          {txnButtonText(pendingTransactions, "unstaking", "Withdraw VEFI")}
                        </Button>
                      </TabPanel>
                      <TabPanel value={view} index={2} className="stake-tab-panel">
                        ...
                        >
                          {txnButtonText(pendingTransactions, "unstaking", "Claim VEFI")}
                        </Button>
                      </TabPanel>
                    </Box>
                  </Box>
                  ...
                  <div className={`stake-user-data`}>
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{trim(kageBalance, 4)} VEFI</>}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{trimmedBalance} VEFI</>}
                      </Typography>
                    </div>
                    ...
                    <div className="data-row">
                      ...
                      <Typography variant="body1">
                        {isAppLoading ? <Skeleton width="80px" /> : <>{trim(kageEarned, 2)} VEFI</>}
                      </Typography>
                    </div>
                    <div className="data-row">
